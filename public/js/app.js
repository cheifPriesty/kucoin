const EmailForm = document.querySelector("#emailLogin");
const PhoneForm = document.querySelector("#PhoneLogin");
...
Phonebtn.onclick = (e) => {
  ...
  let formData = {
    ...
    PhonePassword: PhonePassword.value,
  };
  console.log(formData);
  const handleFetchForm = async () => {
    const request = await fetch("/", {
...
selected_option.addEventListener("click", () => {
  ...
  label.classList.toggle("zIndex");
  selecte_option.classList.toggle("mb");
});
